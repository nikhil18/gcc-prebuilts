...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/nathan/Toolchains/aarch64-linaro-linux-gnu-7.x/aarch64-linaro-linux-gnu/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
